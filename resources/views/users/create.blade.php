                            ...
                            <div class="field">
                                ...
                                <p class="control">
                                    <input class="input" type="text" placeholder="Confirmation No."
                                        name="confirmationNo" value="{{ (old('confirmationNo')) }}" />
                                </p>
                            </div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="contactNo" type="text" class="form-control @error('contactNo') is-invalid @enderror" name="contactNo"
            value="{{ old('contactNo') }}" required autocomplete="contactNo" autofocus>
